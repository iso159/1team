...
<body>
	...
	<div class="container">	
		<h2>도시 수정 화면</h2>
		<form id="updateForm" class="form-inline" action="${pageContext.request.contextPath}/city/cityUpdate" method="post">
		<div class="row">
				<div class="col-md-4">
					<label for="code">도시 코드:</label>
					<input class="form-control" type="text" name="cityId" value="${city.cityId}" readonly>
