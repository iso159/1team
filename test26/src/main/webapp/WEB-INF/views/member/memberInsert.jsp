...
<body>
	...
	<div class="container">
		<h2>회원 가입 화면</h2>
		<form id="signUpForm" class="form-inline" action="${pageContext.request.contextPath}/member/memberInsert" method="post">
			<div class="row">
				<div class="col-md-4">
					<label for="code">아이디</label>
					<input id="userId" class="form-control" type="text"  name="memberId">
					<label for="title">비밀번호</label>
					<input id="userPw" class="form-control" type="password"  name="memberPw">
					<button type="button" id="signUpBtn" class="btn btn-info">회원 가입</button>
				</div>
			</div>
		</form>
	</div>
